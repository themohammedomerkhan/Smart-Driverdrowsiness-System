...
classes = ['Closed', 'Open']
face_cascade = cv2.CascadeClassifier("C:\\driver_drowsiness_system_CNN\\data\\haarcascade_frontalface_default.xml")
left_eye_cascade = cv2.CascadeClassifier("C:\\driver_drowsiness_system_CNN\\data\\haarcascade_lefteye_2splits.xml")
right_eye_cascade = cv2.CascadeClassifier("C:\\driver_drowsiness_system_CNN\\data\\haarcascade_righteye_2splits.xml")
model = load_model("C:\\driver_drowsiness_system_CNN\\drowiness_new7.h5")
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if status1 == 0 and status2 == 0: # Assuming 0 is closed state
            count += 1
